# -*- coding: utf-8 -*-
"""
Dashboard Pós-Vendas Supley — Streamlit v5
...
st.set_page_config(page_title='Pós-Vendas Supley', page_icon='📋',
...
# ─── APLICAR FILTROS ──────────────────────────────────────────────────────────
df = df_raw.copy()
if rep_sel    != 'Todos':              df = df[df['RepNome'] == rep_sel]
...
st.markdown('---')
st.caption('Pós-Vendas Supley · Dados via Google Sheets')
